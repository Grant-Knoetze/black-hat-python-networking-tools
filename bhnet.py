...
# execute function receives a command, runs it, and returns the output as a string, execute function contains
# subprocess library we use the check_output method from subprocess inside the execute function which runs a command
